...
<div class="container mt-5">
  ...
  <?php foreach($hkm as $al)
   ...
   <a href="<?php echo base_url("index.php/admin/showabout?id=").$al['id']?>"><button type="submit" class="btn btn-warning mt-3 " style="float: right; border-radius: 5px;" >Güncelle</button> </a> 
