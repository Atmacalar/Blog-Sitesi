...
<i><?php echo $al['text']; ?> </i> <br> <br> <br> 
<a href="<?php echo base_url("index.php/admin/silproje/?id=").$al['id'] ?>"><button type="submit" class="btn btn-danger mx-1 " style="float: right; border-radius: 5px;" >Sil</button></a>

   <a href="<?php echo base_url("index.php/admin/showprojects/?id=").$al['id'] ?>"><button type="submit" class="btn btn-warning " style="float: right; border-radius: 5px;" >Güncelle</button> </a> 
