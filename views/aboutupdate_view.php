...
<?php foreach ($gtr as $al) { ?>
    
<div class="container mt-1">
<form method="POST" action="<?php echo base_url("index.php/admin/updateabout/?id=").$al['id']?>">
  
  
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Metin</label>
    <textarea class="form-control" style="height: 400px;" name="mylife" rows="3"> <?php echo $al['mylife'] ?> </textarea>
  </div>
