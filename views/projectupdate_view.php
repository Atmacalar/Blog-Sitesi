...
<form method="POST" action="<?php echo base_url("index.php/admin/updateprojects/?id=").$al['id']; ?>">
  ...
  <div class="form-group">
    <label for="exampleFormControlInput2">Açıklama</label>
    <input type="text" class="form-control" name="text" value="<?php echo $al['text'] ?>" >
  </div>
