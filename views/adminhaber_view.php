...
{ ?>
  ...
  <b><?php echo $al['baslik'] ?></b><br>
  <p><?php echo $al['intro'] ?></p>
  <i><?php echo $al['metin'] ?></i><br><br>
  <a href="<?php echo base_url("index.php/admin/silhaber/?id=").$al['id']?>">  <button type="submit" class="btn btn-danger mx-1 "  style="float: right; border-radius: 5px;" >Sil</button></a>

  <a href="<?php echo base_url("index.php/admin/shownews?id=").$al['id'] ?>">  <button type="submit" class="btn btn-warning " style="float: right; border-radius: 5px;" >Güncelle</button> </a>
