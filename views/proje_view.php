...
<body>
   <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
          ...
          <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo base_url("index.php/Anasayfa/haberler"); ?>">Haber İçerikleri</a></li>
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="#">Projeler</a></li>
  ...
  <div class="container"  style="border:1px solid black;">
    ...
    <?php 
     ...
     foreach($projes as $al)  { ?>

     <h4 style="align:center; margin-top:5px;"> <b><?php echo $al['baslik'] ?></b></h4>


    <p><i><?php echo $al['text'] ?></i></p>
